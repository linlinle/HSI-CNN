function net = KSC_cnn_cifar_nin(varargin)
...
net.layers{end+1} = struct('name', 'pool2', ...
                           ...
                           'stride', 2, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'dropout', 'name', 'dropout2', 'rate', 0.5) ;%4*4

% Block 3
net.layers{end+1} = struct('type', 'conv', ...
                           'name', 'conv3', ...
                           'weights', {init_weights(5,192,192)}, ...
                           'learningRate', lr, ...
                           'stride', 1, ...
                           'pad', 2) ;
